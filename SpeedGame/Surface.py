...
File Surface.py     : định nghĩa các vật lớp trong game ( hình ảnh, đối tượng game, control ).
...
from Basic import Color, Vector2, StaticClassMeta, Resource, Font, font
...
class ImageProcessor(metaclass=StaticClassMeta):
    ...
    @staticmethod
    def __doc__():
        return 'Class ImageProcessor : lớp xử lí hình ảnh trong game.'
    ...
    def rect(
        ...
        surface = ImageProcessor.surface(size)
        pygame.draw.rect(surface, color, (0, 0) + size, width, border_radius, border_top_left_radius,
...
if __name__ == '__main__':
    ...
    # app.init((800, 600), 'Bobo Game')
    # app.cursor.set_visible(False)
    # app.cursor_display = CursorShoot()
    # fps = FPSLabel(20, (100, 100), Color.Chocolate)
    #
    # while True:
