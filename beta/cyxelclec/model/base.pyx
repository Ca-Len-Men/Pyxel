from pyxelclec.pattern import Singleton, Static
from pyxelclec.model.canvas import root, update_behaviour

import sys
import pygame
import pygame.freetype

class TimeInput(Singleton):
    def __init__(self):
...
class GameSystem(Singleton):
    @classmethod
    def init(cls, size, caption=None, icon_path=None):
