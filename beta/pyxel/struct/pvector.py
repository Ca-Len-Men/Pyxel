...
class VectorDependent(Vector):
    ...
    def only_set(self, source):
        if self.__ref_vector:
            super().only_set(Vector(source[0] - self.__ref_vector.x,
                                    source[1] - self.__ref_vector.y))
        else:
            super().only_set(source)
    ...
    def x(self):
        ...
        if self.__ref_vector is None:
            return self._x
        return self.__ref_vector.x + self._x
    ...
    def y(self):
        ...
        if self.__ref_vector is None:
            return self._y
        return self.__ref_vector.y + self._y
